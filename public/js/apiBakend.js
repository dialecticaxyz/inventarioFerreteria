...
function deleteOnlyVenta(id){
  return new Promise(function(resolve,reject){
    fetch(url+`/deleteOnlyVenta`,{method:'post',headers:{'Accept':'application/json, text/plain','Content-Type':'application/json','x-access-token':token},
